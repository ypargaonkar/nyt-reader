...
const sectionColors: Record<string, { bg: string; text: string; accent: string }> = {
  ...
  "opinion": { bg: "from-purple-500/20 to-purple-600/10", text: "text-purple-600 dark:text-purple-400", accent: "bg-purple-500" },
  ...
  "magazine": { bg: "from-pink-500/20 to-pink-600/10", text: "text-pink-600 dark:text-pink-400", accent: "bg-pink-500" },
  ...
  "briefing": { bg: "from-slate-500/20 to-slate-600/10", text: "text-slate-600 dark:text-slate-400", accent: "bg-slate-500" },
  "the morning": { bg: "from-slate-500/20 to-slate-600/10", text: "text-slate-600 dark:text-slate-400", accent: "bg-slate-500" },
  "times insider": { bg: "from-amber-500/20 to-amber-600/10", text: "text-amber-600 dark:text-amber-400", accent: "bg-amber-500" },
  "insider": { bg: "from-amber-500/20 to-amber-600/10", text: "text-amber-600 dark:text-amber-400", accent: "bg-amber-500" },
  "dining": { bg: "from-rose-500/20 to-rose-600/10", text: "text-rose-600 dark:text-rose-400", accent: "bg-rose-500" },
  "obituaries": { bg: "from-stone-500/20 to-stone-600/10", text: "text-stone-600 dark:text-stone-400", accent: "bg-stone-500" },
  "your money": { bg: "from-emerald-500/20 to-emerald-600/10", text: "text-emerald-600 dark:text-emerald-400", accent: "bg-emerald-500" },
