...
const sectionColors: Record<string, { text: string; divider: string }> = {
  ...
  "opinion": { text: "text-purple-600 dark:text-purple-400", divider: "bg-purple-500" },
  ...
  "magazine": { text: "text-pink-600 dark:text-pink-400", divider: "bg-pink-500" },
  ...
  "briefing": { text: "text-slate-600 dark:text-slate-400", divider: "bg-slate-500" },
  "the morning": { text: "text-slate-600 dark:text-slate-400", divider: "bg-slate-500" },
  "times insider": { text: "text-amber-600 dark:text-amber-400", divider: "bg-amber-500" },
  "insider": { text: "text-amber-600 dark:text-amber-400", divider: "bg-amber-500" },
  "dining": { text: "text-rose-600 dark:text-rose-400", divider: "bg-rose-500" },
  "obituaries": { text: "text-stone-600 dark:text-stone-400", divider: "bg-stone-500" },
  "your money": { text: "text-emerald-600 dark:text-emerald-400", divider: "bg-emerald-500" },
